 ...
 * {@link DrillsFragment.OnFragmentInteractionListener} interface
...
public class DrillsFragment extends Fragment
{
    ...
    {
        View baseView = inflater.inflate(R.layout.fragment_drills, null);
        drillsView = (WebView) baseView.findViewById(R.id.drillsWebView);
        loadDialog = ProgressDialog.show(baseView.getContext(), "Loading Drills","Please wait...", true);
        loadDialog.setCancelable(false);
        String derp  = "file:///android_asset/drills.html";
        drillsView.getSettings().setLoadWithOverviewMode(true);
        drillsView.getSettings().setUseWideViewPort(true);
        drillsView.getSettings().setJavaScriptEnabled(true);


        drillsView.setWebViewClient(new DrillsViewClient());
    ...
    private class DrillsViewClient extends WebViewClient
    {
        @Override
