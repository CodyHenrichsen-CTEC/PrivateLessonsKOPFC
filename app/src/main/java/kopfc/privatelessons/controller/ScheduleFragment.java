...
public class ScheduleFragment extends Fragment
{
    ...
    {
        View baseView = inflater.inflate(R.layout.fragment_schedule, null);
        scheduleView = (WebView) baseView.findViewById(R.id.scheduleWebView);
        String derp  = "file:///android_asset/schedule.html";
        scheduleView.getSettings().setLoadWithOverviewMode(true);
        scheduleView.getSettings().setUseWideViewPort(true);
        scheduleView.getSettings().setJavaScriptEnabled(true);


        scheduleView.setWebViewClient(new ScheduleViewClient());
    ...
    private class ScheduleViewClient extends WebViewClient
    {
        @Override
